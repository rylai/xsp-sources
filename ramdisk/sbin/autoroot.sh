...
then
	...
	# [Terminal app] remove existing occurances and push app
	echo "[Terminal app] remove existing occurances and push app" >> /data/local/tmp/autorootlog.txt
	/sbin/busybox rm /system/app/Terminal.apk
	/sbin/busybox rm /data/app/Terminal.apk
	/sbin/busybox cp /res/autoroot/Terminal.apk /system/app/Terminal.apk
	/sbin/busybox chown root.root /system/app/Terminal.apk
	/sbin/busybox chmod 0644 /system/app/Terminal.apk
